    ...
    <>
      ...
      >
        <motion.div
          ...
          className="rounded-full blur-[15px] pointer-events-none"
          style={{ background: "linear-gradient(135deg, rgba(0,212,255,1) 0%, rgba(124,58,237,1) 100%)" }}
        />
      </motion.div>
      ...
      >
        <motion.div 
          ...
          style={{ color: "#00d4ff", filter: "drop-shadow(0px 0px 8px rgba(0,212,255,0.8))" }}
        >
          <MousePointer2 size={24} fill="rgba(0,212,255,0.15)" absoluteStrokeWidth strokeWidth={1.5} color="#00d4ff" />
        </motion.div>
      </motion.div>
    </>
  );
