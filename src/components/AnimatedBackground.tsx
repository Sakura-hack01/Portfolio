...
export default function AnimatedBackground() {
  ...
  if (!mounted || (typeof window !== "undefined" && window.matchMedia("(prefers-reduced-motion: reduce)").matches)) {
    return <div className="fixed inset-0 w-full h-full bg-[#030712]" style={{ zIndex: 0 }} />;
  }

  return (
    <div className="fixed inset-0 w-full h-full bg-[#030712]" style={{ zIndex: 0, pointerEvents: "none" }}>
